...
**Этапы 0–4: ✅ ГОТОВЫ и провалидированы владельцем (2026-07-06), включая два раунда фиксов по плейтесту.**

| Этап | Статус |
|---|---|
| 0 — Стабилизация | ✅ |
| 1 — Ощущение боя (смерть/флинч врагов, i-frames, спринт-анимация) | ✅ (звуковые эффекты — слоты пусты) |
| 2 — Оружие + прочность (модели в руке, свои замахи с оружием) | ✅ |
| 3 — Волны | ✅ |
| 4 — Меню + гардероб + сейвы + музыка | ✅ (материалы скинов — слоты пусты) |
| 5 — Полировка и билд | ⬜ следующий |

**Оставшиеся контент-хвосты (не блокируют):** клип кика (Mixamo Roundhouse Kick → стейт `Kick`), звуковые эффекты по слотам (шаги/удары/попадания/блок/смерти), материалы скинов, кнопка «В меню» на панели game over, лицензии новых паков в таблицу D5.

**Следующий этап:** 5 — Полировка и билд (пауза, настройки громкости/сенсы, Quality, Windows-билд, itch.io).
